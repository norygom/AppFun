...
<h2>Nueva Localidad</h2>
        <form action="localidad_n.jsp" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue">
    ...
    <p><a href="list_localidad.jsp">Listado de Localidades</a></p>
