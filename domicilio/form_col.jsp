...
<body>	
<h2>Nueva Colonia</h2>
        <form action="colonia_n.jsp" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue">
            <table width="278" border="1">
                <tr>
                    <td width="98">Nombre</td>
                    <td width="164"><input name="nombre" type="text" id="nombre" size="20" maxlength="20" /></td>
                </tr>
                <tr>
    ...
    <p><a href="list_colonia.jsp">Listado de Colonias</a></p>
