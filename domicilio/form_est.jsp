...
<body>
<h2>Nuevo Estado</h2>
        <form action="estado_n.jsp" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue">
    ...
    <p><a href="list_estado.jsp">Listado de Estados</a></p>
